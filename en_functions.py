...
try:
	with open('achievements.json', 'r') as fh:
		data = json.load(fh)
	...
	with open('achievements.json', mode='w') as f:
		json.dump(dict, f)
...
try:
	with open('save.json', 'r') as fh:
		...
		print('Detected saved data. Nickname: {}, company: {}, capital: ${}, workshop:{}'.format(nickname, company, money, workshop))
except:
	nickname = input('Input nickname: ')
	company = input('Input company name: ')
	achievements.append('My opportunity')
	print('You get achievement: My opportunity!')
	dict = {}
	dict['achievements'] = achievements
	with open('achievements.json', mode='w') as f:
		json.dump(dict, f)
...
def money_help():
	...
	achievements.append('Shut up and take my money!')
	dict = {}
	dict['achievements'] = achievements
	with open('achievements.json', mode='w') as f:
		json.dump(dict, f)
	print('You get achievement: Shut up and take my money!')
	return None
...
def virus():
	...
	if a_v == c_1:
		...
		no = 'No'
		if a_v_c == yes:
			achievements.append('My first hack')
			print('You get achievement: My first hack')
			...
			if res == int('0'):
				...
				if reaction == int('2'):
					achievements.append('Im a very lucky')
					print('You get achievement: Im a very lucky')
					...
					if money > count:
						...
						achievements.append('Hack = end')
						print('You get achievement: Hack = end')
				...
				achievements.append('Im a pro-hacker')
				print('You get achievement: Im a pro-hacker')
				time.sleep(2)
				try:
		...
		if a_v_c == yes:
			...
			if res == int('0'):
				...
				if reaction == int('2'):
					achievements.append('Im a very lucky')
					print('You get achievement: Im a very lucky')
					print('Your attempt was discovered. Your account was debited for $2500')
					count = int('2500')
					if money > count:
						count_res = money - count
						money = count_res
...
def works():
	...
	class work:
		...
		achievements.append('Work is the best praktice')
		print('You get achievement: Work is the best praktice')
		if a == w1:
...
def new_car():
	achievements.append('My first car')
	print('You get achievement: My first car')
	global workshop
	global count_cars
	count_cars = int('0')
	try:
	...
	def compilar_car():
		...
		if car_answer == yes:
			...
			if money < int('0'):
				achievements.append('Bankrupt - my second name')
				print('You get achievement: Bankrupt - my second name')
